...
document.addEventListener('DOMContentLoaded', () => {
    ...
    registerForm.addEventListener('submit', async (e) => {//adding an eventlistener on the form through submit button.
        e.preventDefault();
        const formData = new FormData(registerForm);//getting information from the user for registration
        ...
        try {
            const response = await fetch('/register', {
                ...
                body: JSON.stringify({ username, password, email, full_name })//this translating JavaScript data into a JSON string for registration.
            });
            if (response.ok) {
